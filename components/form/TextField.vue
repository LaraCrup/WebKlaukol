    ...
    <div class="w-full flex flex-col gap-2">
        ...
        <div class="relative">
            <input :id="id" type="text" :placeholder="placeholder" :value="modelValue"
                ...
                :autocomplete="autocomplete" class="w-full border-2 border-primary rounded-[9px] text-sm outline-none p-[0.65rem] pl-9 placeholder:text-gray placeholder:text-sm" />

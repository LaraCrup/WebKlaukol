<template>
    <form @submit.prevent="handleSubmit" class="w-full flex flex-col gap-2">
        ...
        <div class="flex mt-1">
            ...
            <div class="ml-1">
                <label for="terminos" class="text-xs xl:text-base 2xl:text-xl text-gray cursor-pointer">
                    Al inscribirme acepto los <a href="/terminos-y-condiciones" target="_blank" rel="noopener noreferrer" class="text-primary underline">términos y condiciones</a>.
                </label>
        ...
        <button type="submit"
            class="bg-primary hover:bg-primaryHover rounded-[9px] text-white md:text-xl 2xl:text-2xl font-semibold transition-all duration-300 p-3 mt-2 md:mt-4"
